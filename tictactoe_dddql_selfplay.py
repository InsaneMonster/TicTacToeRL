...
from src.tictactoe_environment_selfplay import TicTacToeEnvironmentSelfPlay, Player
...
if __name__ == "__main__":
    ...
    #       - success threshold to consider both the training completed and the experiment successful is 30% of match won by the agent (depending on reward assigned)
    ...
    environment_low_reward: TicTacToeEnvironmentSelfPlay = TicTacToeEnvironmentSelfPlay(environment_name, Player.o,
                                                                                        1.0, -0.1, 0.0,
                                                                                        dddqn_epsilon_greedy_agent)
    environment_high_reward: TicTacToeEnvironmentSelfPlay = TicTacToeEnvironmentSelfPlay(environment_name, Player.o,
                                                                                         100.0, -10.0, 0.0,
                                                                                         dddqn_epsilon_greedy_agent)
    # Define interfaces
