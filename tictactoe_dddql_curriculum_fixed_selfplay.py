...
from src.tictactoe_environment_selfplay import TicTacToeEnvironmentSelfPlay
...
if __name__ == "__main__":
    ...
    dddqn_curriculum_agent_second: DDDQLTicTacToeAgent = _define_curriculum_agent(inner_model_second,
                                                                                  ...
                                                                                  0.25)
    # Generate Tic Tac Toe environments with fixed and selfplay environment player and using the O player as the environment player with two reward types
    ...
    environment_name: str = 'TicTacToeSelfPlay'
    environment_selfplay_low_reward: TicTacToeEnvironmentSelfPlay = TicTacToeEnvironmentSelfPlay(environment_name, Player.o,
                                                                                                 1.0, -0.1, 0.0,
                                                                                                 dddqn_curriculum_agent_second)
    environment_selfplay_high_reward: TicTacToeEnvironmentSelfPlay = TicTacToeEnvironmentSelfPlay(environment_name, Player.o,
                                                                                                  100.0, -10.0, 0.0,
                                                                                                  dddqn_curriculum_agent_second)
    # Define interfaces
    ...
    interface_low_reward_selfplay: TicTacToePassThroughInterface = TicTacToePassThroughInterface(environment_selfplay_low_reward)
    interface_high_reward_selfplay: TicTacToePassThroughInterface = TicTacToePassThroughInterface(environment_selfplay_high_reward)
    # Define experiments
    ...
    experiment_low_reward_fixed: TicTacToeExperiment = TicTacToeExperiment("experiment_low_reward", success_threshold,
                                                                           ...
                                                                           dddqn_curriculum_agent_first, interface_low_reward_fixed)
    success_threshold: float = 0.30
    experiment_low_reward_selfplay: TicTacToeExperiment = TicTacToeExperiment("experiment_low_reward", success_threshold,
                                                                              environment_selfplay_low_reward,
                                                                              dddqn_curriculum_agent_second, interface_low_reward_selfplay)
    success_threshold: float = 65.0
    experiment_high_reward_fixed: TicTacToeExperiment = TicTacToeExperiment("experiment_high_reward", success_threshold,
                                                                            environment_fixed_high_reward,
                                                                            dddqn_curriculum_agent_first, interface_high_reward_fixed)
    success_threshold: float = 30.0
    experiment_high_reward_selfplay: TicTacToeExperiment = TicTacToeExperiment("experiment_high_reward", success_threshold,
                                                                               environment_selfplay_high_reward,
                                                                               dddqn_curriculum_agent_second, interface_high_reward_selfplay)
    ...
    saved_metagraph_paths: [] = run_experiment(experiment_low_reward_fixed,
                                               training_episodes,
    ...
    for metagraph_path in saved_metagraph_paths:
        run_experiment(experiment_low_reward_selfplay,
                       training_episodes,
                       max_training_episodes, episode_length_max,
                       validation_episodes,
                       testing_episodes, test_cycles,
    ...
    saved_metagraph_paths: [] = run_experiment(experiment_high_reward_fixed,
                                               training_episodes,
                                               max_training_episodes, episode_length_max,
                                               validation_episodes,
                                               testing_episodes, test_cycles,
                                               ...
                                               logger, None, experiment_iterations_number)
    for metagraph_path in saved_metagraph_paths:
        run_experiment(experiment_high_reward_selfplay,
                       training_episodes,
                       max_training_episodes, episode_length_max,
                       validation_episodes,
                       testing_episodes, test_cycles,
